package com.framework.pay.core.client.impl.weixin;
...
import com.framework.pay.core.client.util.Fileutils;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    public static String getErrorMessage(WxPayException e) {
        if (StrUtil.isNotEmpty(e.getErrCode())) {
